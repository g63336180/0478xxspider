...
$configs = array(
    ...
    'list_url_regexes' => array(
        'http://www.guxiaobei.com/page/\d+',
    ),
    'content_url_regexes' => array(
        "http://www.guxiaobei.com/\w+",
    ),
    'max_try' => 1,
    'export' => array(
        'type' => 'db', 
    ...
    'fields' => array(
        array(
            'name' => "title",
            'selector' => "//section[@class='container']/div[@class='content-wrap']/div[@class='content']/header[@class='article-header']/h1[@class='article-title']/a",
            //'selector' => "/html/body/center/div[@class='maintable'][4]/div[@class='spaceborder']/table/tbody/tr[@class='header']/td/text()",
            'required' => true,
        ),
        array(
            'name' => "content",
            'selector' => "//section[@class='container']/div[@class='content-wrap']/div[@class='content']/article[@class='article-content']/p",
            'repeated' => true,
            'required' => true,
        ),
        array(
            'name' => 'category_id',
            'selector' => "//section[@class='container']/div[@class='content-wrap']/div[@class='content']/header[@class='article-header']/div[@class='meta']/span[@id='mute-category']/a",
        ),
        array(
            'name' => 'user_id',
            'selector' => "",
...
$spider->on_scan_page = function($page, $html, $spider){
    ...
    // foreach ($category as $ck => $cv) {
      for ($i = 1; $i < 14; $i ++) {
          $spider->add_url('http://www.guxiaobei.com/page/' . $i);
      }
    // }
};
