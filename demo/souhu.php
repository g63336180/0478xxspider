...
$configs = array(
	...
	'content_url_regexes' => array(
		"http://house.focus.cn/loupan/\d+.html",
    ...
    'fields' => array(
        ...
        array(
            'name' => "title",
            'selector' => "//div[contains(@class,'loupan-detail-head')]//div[contains(@class,'loupan-name-right1')]//h1",
        ...
        array(
            'name' => "price",
            'selector' => "//div[contains(@class, 'loupan-info')]//div[contains(@class, 'loupan-info-detail')]//div[contains(@class,'lp-price')]//strong",
        ),
        // 开盘时间
        array(
            'name' => "open_datetime",
            'selector' => "//div[contains(@class, 'loupan-info')]//div[contains(@class, 'loupan-info-detail')]//div[@class='lp-info-p']//span[contains(@class, 'over-txt')]",
        ),
    ),
);
...
{
    //requests::set_header('Referer','http://house.focus.cn/search/index.html');
};
