...
$configs = array(
    ...
    'scan_urls' => array(
        'http://www.chinajac.com/',
    ),
    'list_url_regexes' => array(
        'http://www.chinajac.com/category/\w+/',
        'http://www.chinajac.com/category/\w+/page/\d+/',
    ),
    'content_url_regexes' => array(
        "http://www.chinajac.com/\d+/\d+/\d+/",
    ),
    'max_try' => 1,
    'export' => array(
        'type' => 'db', 
    ...
    'fields' => array(
        array(
            'name' => "title",
            'selector' => "//div[@class='main-content']/div[@id='content']/div[@class='content-single']/div[@class='content-detail']/div[@class='single-content']/article/div[@class='post-box']/header/h1",
            //'selector' => "/html/body/center/div[@class='maintable'][4]/div[@class='spaceborder']/table/tbody/tr[@class='header']/td/text()",
            'required' => true,
        ),
        array(
            'name' => "content",
            'selector' => "//div[@class='detail-page']/div[@class='main-content']/div[@id='content']/div[@class='content-single']/div[@class='content-detail']/div[@class='single-content']/article/div[@class='post-box']/div[@class='post-inner']/div[@class='post-content entry-content single-post-content']/p",
            'repeated' => true,
            'required' => true,
        ),
        array(
...
$spider->on_scan_page = function($page, $html, $spider){
    ...
    foreach ($category as $ck => $cv) {
      for ($i = 1; $i < 100; $i ++) {
          $spider->add_url('http://www.chinajac.com/category/' . $cv . '/page/' . $i . '/');
      }
    }
};
